...
/**
 * REST controller for managing {@link com.activeport.web.domain.UserRole}.
 */
@RestController
@RequestMapping("/api")
public class UserRoleResource {
    ...
    public ResponseEntity<List<UserRoleDTO>> getAllUserRoles(
        ...
        Page<UserRoleDTO> page;
        if (eagerload) {
            page = userRoleService.findAllWithEagerRelationships(pageable);
        } else {
            page = userRoleService.findAll(pageable);
        }
