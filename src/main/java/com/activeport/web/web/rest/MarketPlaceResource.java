...
/**
 * REST controller for managing {@link com.activeport.web.domain.MarketPlace}.
 */
@RestController
@RequestMapping("/api")
public class MarketPlaceResource {
    ...
    /**
     * {@code POST  /market-places} : Create a new marketPlace.
     *
    ...
    public ResponseEntity<MarketPlaceDTO> createMarketPlace(@RequestBody MarketPlaceDTO marketPlaceDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            .created(new URI("/api/market-places/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /market-places} : Updates an existing marketPlace.
     *
    ...
    public ResponseEntity<MarketPlaceDTO> updateMarketPlace(@RequestBody MarketPlaceDTO marketPlaceDTO) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, marketPlaceDTO.getId().toString()))
            .body(result);
    }

    /**
     * {@code GET  /market-places} : get all the marketPlaces.
     *
    ...
    public ResponseEntity<List<MarketPlaceDTO>> getAllMarketPlaces(Pageable pageable) {
        log.debug("REST request to get a page of MarketPlaces");
        Page<MarketPlaceDTO> page = marketPlaceService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }

    /**
     * {@code GET  /market-places/:id} : get the "id" marketPlace.
     *
    ...
    /**
     * {@code DELETE  /market-places/:id} : delete the "id" marketPlace.
     *
