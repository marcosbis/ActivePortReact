...
export const DeviceConfigurationDeleteDialog = (props: IDeviceConfigurationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="activePortApp.deviceConfiguration.delete.question">
        <Translate contentKey="activePortApp.deviceConfiguration.delete.question" interpolate={{ id: deviceConfigurationEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-deviceConfiguration" color="danger" onClick={confirmDelete}>
