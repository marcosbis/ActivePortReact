  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="activePortApp.location.home.createOrEditLabel">
            <Translate contentKey="activePortApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : locationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="codeLabel" for="location-code">
              ...
              <AvGroup>
                ...
                <AvField id="location-description" type="text" name="description" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="uuidLabel" for="location-uuid">
                  <Translate contentKey="activePortApp.location.uuid">Uuid</Translate>
                </Label>
                <AvField id="location-uuid" type="text" name="uuid" />
              </AvGroup>
