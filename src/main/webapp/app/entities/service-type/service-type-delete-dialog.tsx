...
export const ServiceTypeDeleteDialog = (props: IServiceTypeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="activePortApp.serviceType.delete.question">
        <Translate contentKey="activePortApp.serviceType.delete.question" interpolate={{ id: serviceTypeEntity.id }}>
          Are you sure you want to delete this ServiceType?
        </Translate>
      </ModalBody>
      <ModalFooter>
