  ...
  return (
    <div>
      <h2 id="organization-heading">
        <Translate contentKey="activePortApp.organization.home.title">Organizations</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="activePortApp.organization.home.createLabel">Create new Organization</Translate>
        </Link>
      </h2>
        ...
        {organizationList && organizationList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="activePortApp.organization.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('hostId')}>
                  <Translate contentKey="activePortApp.organization.hostId">Host Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="activePortApp.organization.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('billing')}>
                  <Translate contentKey="activePortApp.organization.billing">Billing</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('timeZone')}>
                  <Translate contentKey="activePortApp.organization.timeZone">Time Zone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {organizationList.map((organization, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{organization.hostId}</td>
                  <td>{organization.description}</td>
                  <td>{organization.billing ? 'true' : 'false'}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="activePortApp.organization.home.notFound">No Organizations found</Translate>
            </div>
          )
        )}
      </div>
