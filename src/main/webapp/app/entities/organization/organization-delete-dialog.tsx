...
export const OrganizationDeleteDialog = (props: IOrganizationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="activePortApp.organization.delete.question">
        <Translate contentKey="activePortApp.organization.delete.question" interpolate={{ id: organizationEntity.id }}>
