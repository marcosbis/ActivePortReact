...
export const UserProfileDeleteDialog = (props: IUserProfileDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="activePortApp.userProfile.delete.question">
        <Translate contentKey="activePortApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-userProfile" color="danger" onClick={confirmDelete}>
